...
Countries Currencies Languages or countries_currencies_languages is a package
that contains static information about 

* Countries: e.g. its offical name, its language 
* Currencies: e.g. its iso4217 code
* Language: e.g. its iso639 alpha3 code

On top of all information of iso639, iso3166, and iso4217 some additional
information is contained.

The main entry point into the data are these three functions:

```D
import countries_currencies_languages;
...
The structs *Language*, *Country*, and *Currency* have the following form.
...
The files languages.d, countries.d, currencies.d are generated by parser.d.
To change their content or to add new information please adjust parser.d.
The makefile contains the python package to clone to get some of the
